...
class InternalSubscribe<T> extends Message implements QueueableWork {
    ...
    InternalSubscribe(NonBlockingClientImpl client, String topic, QOS qos, int credit, boolean autoConfirm, int ttl, DestinationListener<T> destListener, T context) {
        ...
        this.ttl = ttl;
        this.destListener = new DestinationListenerWrapper<T>(client, destListener, context);
    }
}